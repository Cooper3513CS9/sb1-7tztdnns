...
export default function Step1Household() {
  const { userData, colors } = useUserData();
  
  return (
    <Card title="Stap 1: Uw Huishouden" icon={<Users size={28} style={{color: colors.primary}}/>}>
      ...
      <StepNavigation nextStep="intake-step2" />
      <StepProgress step={1} stepTitle="Huishouden" /> 
    </Card>
  );
}