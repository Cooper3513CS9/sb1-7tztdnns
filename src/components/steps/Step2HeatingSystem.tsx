...
export default function Step2HeatingSystem() {
  ...
  const showHeatingSystemAge = heating.mainHeatingSystem === 'cv-gas' || heating.mainHeatingSystem === 'cv-hybride';
  
  return (
    <Card title="Stap 3: Uw Verwarming & Warm Water" icon={<Flame size={28} style={{color: colors.primary}}/>}>
      ...
      <StepNavigation prevStep="housing" nextStep="solar" />
      <StepProgress step={3} stepTitle="Verwarming & Warm Water" />
    </Card>
  );
}